...
$router->group(['before' => 'auth'], function ($router){
    $router->get('/products/new', ['\App\Controllers\ProductsController', 'getNew']);
    $router->post('/products/new', ['\App\Controllers\ProductsController', 'postNew']);
    $router->get('/products/edit/{id}', ['\App\Controllers\ProductsController', 'getEdit']);
    $router->put('/products/edit/{id}', ['\App\Controllers\ProductsController', 'putEdit']);
    $router->delete('/products/', ['\App\Controllers\ProductsController', 'deleteIndex']);
...
$router->get('/products/{id}', ['\App\Controllers\ProductsController', 'getIndex']);
$router->post('/products/{id}', ['\App\Controllers\ProductsController', 'postIndex']);
